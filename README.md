...
<title>Rajat Saini — Data Analyst Portfolio</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-right::before {
    ...
    border-radius: 50%;
    background: radial-gradient(circle, rgba(200,57,43,0.15) 0%, transparent 70%);
    top: 50%; left: 50%;
  ...
  #projects .section-num { color: var(--gold); }
  #projects .section-line { background: rgba(255,255,255,0.15); }
...
<!-- NAV -->
<nav>
  <a href="#hero" class="nav-logo">Rajat Saini</a>
  <ul class="nav-links">
...
<section id="hero">
  <div class="hero-left">
    <div class="hero-eyebrow">Entry Level Data Analyst</div>
    <h1 class="hero-name">Rajat<span>Saini</span></h1>
    <p class="hero-role">Data Analytics · Business Intelligence · Banking Analytics</p>
    <p class="hero-summary">
      Results-driven analyst with 4+ years of cross-functional experience, an MBA in Business Analytics,
      and deep expertise in SQL, Python, and Power BI. I turn complex datasets into strategic insights
      that drive decisions at every level of an organisation.
    </p>
    <div class="hero-cta">
      <a href="mailto:rajat9526@gmail.com" class="btn-primary">Get In Touch</a>
      <a href="https://linkedin.com/in/rajat9526" target="_blank" class="btn-outline">LinkedIn</a>
    </div>
  </div>
  ...
  <div class="hero-right">
    <div class="stats-grid">
      <div class="stat-card">
        <div class="stat-number">4<em>+</em></div>
        <div class="stat-label">Years Experience</div>
      </div>
      <div class="stat-card">
        <div class="stat-number">100<em>k</em></div>
        <div class="stat-label">Records Processed</div>
      </div>
      <div class="stat-card">
        <div class="stat-number">22<em>%</em></div>
        <div class="stat-label">Repeat Purchase Lift</div>
      </div>
      <div class="stat-card">
        <div class="stat-number">87<em>%</em></div>
        <div class="stat-label">Model Accuracy</div>
      </div>
    </div>
    <div class="hero-contact">
      <a href="mailto:rajat9526@gmail.com" class="contact-chip">✉ rajat9526@gmail.com</a>
      <a href="https://github.com/rajat9526" class="contact-chip" target="_blank">⌥ github.com/rajat9526</a>
    </div>
  </div>
</section>
...
<div class="marquee-bar">
  <span class="marquee-inner">
    SQL &nbsp;·&nbsp; Python &nbsp;·&nbsp; Power BI &nbsp;·&nbsp; Tableau &nbsp;·&nbsp; DAX &nbsp;·&nbsp; Google BigQuery &nbsp;·&nbsp; A/B Testing &nbsp;·&nbsp; Cohort Analysis &nbsp;·&nbsp; Predictive Modeling &nbsp;·&nbsp; ETL &nbsp;·&nbsp; Credit Risk Analytics &nbsp;·&nbsp; Customer Segmentation &nbsp;·&nbsp; AWS Cloud &nbsp;·&nbsp; MBA Business Analytics &nbsp;·&nbsp; Stakeholder Management &nbsp;·&nbsp;
    SQL &nbsp;·&nbsp; Python &nbsp;·&nbsp; Power BI &nbsp;·&nbsp; Tableau &nbsp;·&nbsp; DAX &nbsp;·&nbsp; Google BigQuery &nbsp;·&nbsp; A/B Testing &nbsp;·&nbsp; Cohort Analysis &nbsp;·&nbsp; Predictive Modeling &nbsp;·&nbsp; ETL &nbsp;·&nbsp; Credit Risk Analytics &nbsp;·&nbsp; Customer Segmentation &nbsp;·&nbsp; AWS Cloud &nbsp;·&nbsp; MBA Business Analytics &nbsp;·&nbsp; Stakeholder Management &nbsp;·&nbsp;
  </span>
</div>
...
<section id="skills">
  ...
  <div class="skills-layout">
    <div class="skill-group">
      <div class="skill-group-label">Technical Stack</div>
      <div class="skill-tags">
        <span class="skill-tag hot">SQL (Advanced)</span>
    ...
    <div class="skill-group">
      <div class="skill-group-label">BI & Visualisation</div>
      <div class="skill-tags">
        <span class="skill-tag hot">Power BI</span>
        <span class="skill-tag hot">DAX</span>
    ...
    <div class="skill-group">
      <div class="skill-group-label">Analytics Expertise</div>
      <div class="skill-tags">
        <span class="skill-tag hot">Credit Risk Analytics</span>
        ...
        <span class="skill-tag">Loan Portfolio Analysis</span>
    ...
    <div class="skill-group">
      ...
      <div class="skill-tags">
        <span class="skill-tag hot">AWS Cloud</span>
        <span class="skill-tag hot">Google Cloud Platform</span>
        <span class="skill-tag">BigQuery</span>
        <span class="skill-tag">DataProc</span>
    ...
    <div class="skill-group">
      <div class="skill-group-label">Domain Knowledge</div>
      <div class="skill-tags">
        <span class="skill-tag hot">Banking & Finance</span>
        <span class="skill-tag">Retail Analytics</span>
        <span class="skill-tag">Supply Chain</span>
        <span class="skill-tag">Marketing ROI</span>
        <span class="skill-tag">Business Intelligence</span>
        <span class="skill-tag">MBA Analytics</span>
      </div>
    </div>
  </div>
</section>
...
<!-- CONTACT -->
<section id="contact">
  <h2 class="contact-headline">Let's build<br><span>something data-driven.</span></h2>
  <p class="contact-sub">Open to analyst roles across Banking, BI, and Product Analytics. Based in Gurugram, India — available immediately.</p>

  <div class="contact-links">
    <a href="mailto:rajat9526@gmail.com" class="contact-link">✉ Email Me</a>
    <a href="https://linkedin.com/in/rajat9526" class="contact-link" target="_blank">in LinkedIn</a>
    <a href="https://github.com/rajat9526" class="contact-link" target="_blank">⌥ GitHub</a>
    <a href="tel:+919911041086" class="contact-link">📞 +91 9911041086</a>
  </div>

  <div class="footer-note">Rajat Saini · Gurugram, Haryana, India · Data Analyst Portfolio 2026</div>
</section>
